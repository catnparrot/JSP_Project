...
<title>Insert title here</title>
	...
	<script>
		...
		function fn_modify_article(obj){
			obj.action = "${contextPath}/board8/modArticle.do";
			obj.submit();	
		}
			...
			<c:if test="${not empty article.imageFileName && article.imageFileName != 'null' }">
		        ...
		        <tr id="tr_btn">
		    		<td colspan=2 align="center">
		    			...
		    			<input type=button value="삭제하기" onClick="fn_remove_article('${contextPath }/board8/removeArticle.do', ${article.articleNO })">
		    			<input type=button value="리스트로 돌아가기" onClick="backToList(this.form)">
		    			<input type=button value="답글쓰기" onClick="fn_reply_form('${contextPath}/board8/replyForm.do', ${article.articleNO })">
		    		</td>
		    	</tr>
	    </table>
    </form>
